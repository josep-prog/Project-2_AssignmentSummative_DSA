...
| Name | Link |
| :---- | :---- |
| **Github repository** | [Project-2\_AssignmentSummative\_DSA](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA.git)  |
| **Question 1 :** job\_heap.c | [q1\_job\_heap.c](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/job_heap.c)  |
| **Question 2 :** passenger\_heap.c | [q2\_passenger\_heap.c](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/passenger_heap.c)  |
| **Question 3 :** kruskal\_mst.c | [q3\_kruskal\_mst.c](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/kruskal_mst.c)  |
| **Question 4 :** bfs\_workstation.c | [q4\_bfs\_workstation.c](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/bfs_workstation.c)  |
| **Question 5 :** bellman\_ford.c | [q5\_bellman\_ford.c](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/bellman_ford.c)  |

### 

### 

### [**Question 1:**](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/job_heap.c) **Job Scheduling Using Max-Heap** 
...
### [**Question 2:**](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/passenger_heap.c) **Airport Security Priority Queue**
...
###  [**Question 3:**](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/kruskal_mst.c) **Fiber-Optic Network Using Kruskal's Algorithm**
...
### [**Question 4:**](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/bfs_workstation.c)  **Cyber Incident Investigation Using BFS**
...
### [**Question 5:**](https://github.com/josep-prog/Project-2_AssignmentSummative_DSA/blob/main/bellman_ford.c) **Banking Risk Analysis Using Bellman-Ford**
